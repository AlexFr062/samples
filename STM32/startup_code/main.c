...
int main(void)
{
  ...
  // See the article, Minimal LED blinking code.
  ...
  *ptr |= 1;
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  //
	  // LD1_GPIO_Port =  0x40000000 +  0x00020000 + 0x0400 = 0x40020400   (GPIO_TypeDef)
	  // LD1_Pin = 1
	  // GPIO_NUMBER = 16
	  //
	  // typedef struct
	  ...
	  // ... } GPIO_TypeDef;
	  //
	  // BSRR: Lower 16 bits have 1's where bits are to be set to "HIGH". Upper 16 bits have 1's where bits are to be set "LOW".
	  ...
	  // These two lines work like HAL_GPIO_TogglePin(LD1_GPIO_Port, LD1_Pin);
